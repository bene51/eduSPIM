...
public class KeyboardButtons extends AbstractButtons implements KeyListener {
	...
	public void keyPressed(KeyEvent e) {
		...
		case KeyEvent.VK_RIGHT: super.fireButtonPressed(BUTTON_Z_UP); break;
		case KeyEvent.VK_LEFT:  super.fireButtonPressed(BUTTON_Z_DOWN); break;
	...
	public void keyReleased(KeyEvent e) {
		...
		case KeyEvent.VK_RIGHT: if(down == BUTTON_Z_UP)   super.fireButtonReleased(down); break;
		case KeyEvent.VK_LEFT:  if(down == BUTTON_Z_DOWN) super.fireButtonReleased(down); break;
